export default function ListShow() {
  return (
    <section className="relative top-24 min-h-screen flex flex-col items-start gap-6 px-5 sm:px-12 md:px-20 xl:px-32">
      {/* List Name */}
      ...
      <div className="tasks w-full">
        <ul className="w-full flex flex-col gap-1">
          {/* One Task */}
          <li className="w-full bg-[#fff]/30 px-4 py-4 sm:px-8 sm:py-5 rounded-3xl shadow-lg flex items-center gap-4 text-base text-md sm:text-lg">
            {/* Checkbox */}
            <input
