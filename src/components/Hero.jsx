...
export default function Hero() {
    useGSAP(() => {
        ...
        .from([".left-leaf", ".right-leaf"], {
            x: (i) => (i === 0 ? -100 : 100),  // 🌿 one goes left, one right
        });       
    ...
    <section id="hero" className="relative top-22 sm:top-15 overflow-hidden min-h-screen">
       ...
       {/* title and button */}
        ...
        <div className="absolute top-55 sm:top-20 left-1/2 -translate-x-1/2 -translate-y-1/2; flex flex-col items-center gap-3 sm:gap-13">            
            ...
            <button className="hero-button px-6 py-2 font-cinzel text-lg text-white rounded-full bg-gradient-to-r from-[#f6b36a] via-[#FF7601] to-[#d84b00] hover:from-[#f39553] hover:to-[#c74000] transition-all duration-300 shadow-md hover:shadow-xl">
                LogIn / SignUP
            </button>
        </div>
